...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    type: "prescription",
    description:
      "Lisinopril is an ACE inhibitor used to treat high blood pressure (hypertension) and heart failure. It works by relaxing blood vessels so blood can flow more easily.",
  ...
  // Pain Management
  {
    ...
    type: "otc",
    description:
      "Ibuprofen is a nonsteroidal anti-inflammatory drug (NSAID) used to reduce fever and treat pain or inflammation caused by conditions such as headache, toothache, back pain, arthritis, or minor injury.",
  ...
  // Mental Health
  {
    ...
    type: "prescription",
    description:
      "Sertraline is a selective serotonin reuptake inhibitor (SSRI) antidepressant used to treat depression, anxiety disorders, and other mental health conditions.",
  ...
  // Supplements
  {
    ...
    type: "supplement",
    description:
      "High-quality omega-3 fish oil supplement containing EPA and DHA to support heart health, brain function, and overall wellness.",
  ...
  // Medical Devices
  {
    ...
    type: "device",
    description:
      "Clinically validated automatic blood pressure monitor with large display, memory storage, and irregular heartbeat detection.",
    ...
    contraindications: [
      "Arrhythmias may affect accuracy",
  ...
  // Women's Health
  {
    ...
    type: "supplement",
    description:
      "Complete prenatal vitamin with folic acid, iron, and DHA to support maternal and fetal health during pregnancy and breastfeeding.",
    ...
    reorderQuantity: 300,
    dosageForm: "capsule",
    dosages: ["1 capsule daily", "2 capsules daily"],
  ...
  // Men's Health - ED Medication
  {
    ...
    type: "prescription",
    description:
      "Sildenafil is used to treat erectile dysfunction (ED) by increasing blood flow to the penis during sexual stimulation.",
  ...
  // Weight Management - GLP1
  {
    ...
    type: "prescription",
    description:
      "Semaglutide is a GLP-1 receptor agonist used for type 2 diabetes management and weight loss. It helps control blood sugar and reduces appetite.",
